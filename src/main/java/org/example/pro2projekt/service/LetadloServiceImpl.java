...
public class LetadloServiceImpl implements LetadloService {
    private final LetadloRepository letadloRepository;
    private final JdbcTemplate jdbcTemplate;
    private final Validator validator = new Validator();

    @Autowired
    public LetadloServiceImpl(LetadloRepository letadloRepository, JdbcTemplate jdbcTemplate) {
        this.letadloRepository = letadloRepository;
